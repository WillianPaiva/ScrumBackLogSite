...
**** task 1
	...
	*a User table like the exemple*

     | id | idUsers | idGroups | firstName | secondName |
     |----+---------+----------+-----------+------------|
     |    |         |          |			     |            |
**** task 2
...
**** task 4
create unit tests and selenuim test for creation , visualization of the Users Table.
** #US18
| NB | description                                                      | m/d |
|----+------------------------------------------------------------------+-----|
