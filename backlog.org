...
|  9 | as a developer or pm i want to create a task                                                        |      3 |          3 |
| 10 | as a developer or pm i want to edit details of a task                                               |      3 |          3 |
| 11 | as a pm i want to give priorities to the tasks                                                      |      3 |          3 |
| 12 | as a developer or pm i want to visualize a list of closed USER STORY and the commits that closed it |      1 |          3 |
...
| NB | description                                                                                         | effort | priorities |
|----+-----------------------------------------------------------------------------------------------------+--------+------------|
| 13 | as a pm i want to create a sprint                                                                   |      5 |          3 |
| 14 | as a pm i want to edit the sprint details                                                           |      3 |          3 |
| 15 | as a pm i want to create a kamban style board for a sprint                                          |     13 |          3 |
| 16 | as a pm i want to create a kamban style board for a project                                         |     13 |          3 |
